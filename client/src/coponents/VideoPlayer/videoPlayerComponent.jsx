        ...
        <div className="control-buttons">
          ...
          <div className="progress-bar">
            <input
              ...
              style={{ background: `linear-gradient(to right, #F50723 ${Math.round((currentTime / duration) * 100)}%, #808080 ${Math.round((currentTime / duration) * 100)}%)` }}
            />
          ...
          <>
            ...
            <AccordionComponent
              items={episodes.map((episode, index) => ({
                ...
                children: (
                  <div
                    className={`episode-item ${index === currentEpisodeIndex ? 'active' : ''}`}
